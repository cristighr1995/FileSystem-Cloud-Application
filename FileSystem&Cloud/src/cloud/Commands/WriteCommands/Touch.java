...
public class Touch extends WriteCommand implements Command {
    ...
    public Touch(TreeFileSystem tfs, UserManagement um, String com, SystemConfiguration sc) {
        mTreeFileSystem = tfs;
        mUserManagement = um;
        command = com;
    ...
    private void parseCommand() {
        try {
            ...
            path = sb.toString();
            fileName = components.get(components.size() - 1);
    ...
    public void execute() {
        ...
        try {
            cmd.touch(path, fileName, paramNr);
